<div class="left-sidebar">
	...
	<?php
		...
		// set the charset to be able to show spanish characters
		$mysqli->set_charset("utf8");

		//MySqli Select Query to get the first letters of categories
		...
		// the loop to show all the data received from database
		while($row = $results->fetch_assoc()) {
			...
			print '<ul>';
			//MySqli Select Query to get the categories starting with the letter
