					...
					<div class="features_items"><!--features_items-->
						...
						<div class="col-sm-12">
							<div class="productinfo text-center">
								...
								<?php
									$results3 = $mysqli->query("SELECT id, name, username, city, left(description, 150) as description FROM list where city like '".$_SESSION["city"]."' ORDER BY id DESC LIMIT 3");
											...
											print '<div class="product-image-wrapper">';
												print '<div class="single-products">';
													...
													print '<div class="item-subtitle">'.$row3["name"].'</div>';
														...
														print '<div class="item-subtitle">('.ucfirst ($row3["city"]).')</div>';
